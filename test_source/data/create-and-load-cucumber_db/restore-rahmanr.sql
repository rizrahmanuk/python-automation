...
-- create folder /tmp/cucumber_db
-- chmod a+rx /tmp/cucumber_db
-- sudo -u postgres psql
-- >\connect cucumber_db
-- >\ir restore-rahmanr.sql
...
--DROP DATABASE cucumber_db;
--
-- Name: cucumber_db; Type: DATABASE; Schema: -; Owner: rahmanr
--

--CREATE DATABASE cucumber_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'English_United States.1252' LC_CTYPE = 'English_United States.1252';


--ALTER DATABASE cucumber_db OWNER TO rahmanr;
...
\.
COPY sandpit_rahmanr.actor (actor_id, first_name, last_name, last_update) FROM '/tmp/cucumber_db/3057.dat';
...
\.
COPY sandpit_rahmanr.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '/tmp/cucumber_db/3065.dat';
...
\.
COPY sandpit_rahmanr.category (category_id, name, last_update) FROM '/tmp/cucumber_db/3059.dat';
...
\.
COPY sandpit_rahmanr.city (city_id, city, country_id, last_update) FROM '/tmp/cucumber_db/3067.dat';
...
\.
COPY sandpit_rahmanr.country (country_id, country, last_update) FROM '/tmp/cucumber_db/3069.dat';
...
\.
COPY sandpit_rahmanr.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '/tmp/cucumber_db/3055.dat';
...
\.
COPY sandpit_rahmanr.film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '/tmp/cucumber_db/3061.dat';
...
\.
COPY sandpit_rahmanr.film_actor (actor_id, film_id, last_update) FROM '/tmp/cucumber_db/3062.dat';
...
\.
COPY sandpit_rahmanr.film_category (film_id, category_id, last_update) FROM '/tmp/cucumber_db/3063.dat';
...
\.
COPY sandpit_rahmanr.inventory (inventory_id, film_id, store_id, last_update) FROM '/tmp/cucumber_db/3071.dat';
...
\.
COPY sandpit_rahmanr.language (language_id, name, last_update) FROM '/tmp/cucumber_db/3073.dat';
...
\.
COPY sandpit_rahmanr.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '/tmp/cucumber_db/3075.dat';
...
\.
COPY sandpit_rahmanr.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '/tmp/cucumber_db/3077.dat';
...
\.
COPY sandpit_rahmanr.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '/tmp/cucumber_db/3079.dat';
...
\.
COPY sandpit_rahmanr.store (store_id, manager_staff_id, address_id, last_update) FROM '/tmp/cucumber_db/3081.dat';
